...
public class Tshirt {
	...
	public String toString() {
		return "Tshirt [" + (id != null ? "id=" + id + ", " : "") + (name != null ? "name=" + name + ", " : "")
				+ (colour != null ? "colour=" + colour + ", " : "") + (size != null ? "size=" + size + ", " : "")
				+ (genderRecommendation != null ? "genderRecommendation=" + genderRecommendation + ", " : "") + "price="
				+ price + ", rating=" + rating + ", " + (availability != null ? "availability=" + availability : "")
				+ "]";
	}
